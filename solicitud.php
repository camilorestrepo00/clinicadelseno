...
// Si es empleado, mostrar solo sus solicitudes (excluyendo certificados, que tienen su propia tabla)
if ($_SESSION['role'] === 'Empleado') {
    ...
    // Si es admin o jefe, mostrar todas las solicitudes (incluyendo certificados en la sección correspondiente)
    $sql = "SELECT s.*, u.nombres_completos 
            FROM solicitudes s 
            JOIN users u ON s.numero_cedula = u.numero_cedula 
            ORDER BY s.fecha_solicitud DESC";
