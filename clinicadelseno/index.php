...
// Modifica la consulta al inicio del archivo
...
<body>
    ...
    <div class="menu">
        <?php
        $secciones = ['inicio', 'crear', 'registrados', 'inactivos', 'solicitudes', 'contratos', 'certificado', 'perfil'];
        $nombres = [
            'inicio' => 'Inicio',
            'crear' => 'Crear Usuario',
            ...
            <div class="welcome-content">
                ...
                <div class="welcome-actions">
                    ...
                    <ul>
                        ...
                        <li>Gestionar solicitudes de empleados</li>
    ...
    <div id="modalRevision" class="modal">
        ...
        // Función para activar/inactivar usuario llamando a toggle_status.php
        var currentSection = '<?= $seccion_actual ?>';
        function cambiarEstado(id, estado) {
            var confirmar = (estado === 'Inactivo') ? '¿Activar este usuario?' : '¿Inactivar este usuario?';
            if (!confirm(confirmar)) return;
            var url = 'toggle_status.php?id=' + encodeURIComponent(id) + '&seccion=' + encodeURIComponent(currentSection);
            // Redirigir para que el PHP haga el cambio y vuelva a la sección
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                ...
                                <form action="emitir_certificado.php?id=<?= intval($r['id']) ?>" method="POST" enctype="multipart/form-data" style="display:flex;gap:6px;align-items:center;">
    ...
    <div id="perfil" class="section <?= ($seccion_actual === 'perfil') ? 'active' : '' ?>">
        ...
        <?php endif; ?>
        <form method="POST">
            <input type="text" name="numero_cedula" placeholder="Número de Cédula" value="<?php echo $user['numero_cedula']; ?>" required>
            <input type="text" name="nombres_completos" placeholder="Nombres Completos" value="<?php echo $user['nombres_completos']; ?>" required>
            <input type="tel" name="telefono_personal" placeholder="Teléfono Personal" value="<?php echo $user['telefono_personal']; ?>">
            <input type="email" name="correo_electronico" placeholder="Correo Electrónico" value="<?php echo $user['correo_electronico']; ?>">
